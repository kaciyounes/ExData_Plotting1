plot4<-function(file){
  ...
  plot(x = data1$Date, y = data1$Global_active_power ,ylab = "Global Active Power", xlab = "", type="l")
  plot(x = data1$Date, y = data1$Voltage ,ylab = "Voltage", xlab = "datetime", type="l")
  ...
  legend("topright"
         ...
         ,lty=c(1,1), lwd=c(1,1))
  plot(x = data1$Date, y = data1$Global_reactive_power ,ylab = "Global_reactive_power", xlab = "datetime", type="l")
  dev.off()
}